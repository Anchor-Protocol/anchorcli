...
import { querySimulation } from '@anchor-protocol/anchor.js/dist/queries/terraswap/simulation';
import { queryNativeSimulation } from '@anchor-protocol/anchor.js/dist/queries/terraswap/native-simulation';
import { queryPool } from '@anchor-protocol/anchor.js/dist/queries/terraswap/pool';
import { queryPair } from '@anchor-protocol/anchor.js/dist/queries/terraswap/pairs';
import { queryReverseNativeSimulation } from '@anchor-protocol/anchor.js/dist/queries/terraswap/reverse-native-simulation';
import { queryReverseTokenSimulation } from '@anchor-protocol/anchor.js/dist/queries/terraswap/reverse-token-simulation';
import { fabricatebSwapLuna } from '@anchor-protocol/anchor.js/dist/fabricators/terraswap/swap-native';
